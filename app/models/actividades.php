...
class Actividades {
   ...
   public static function create($data) {
      $sql = "INSERT INTO actividades(actividad) VALUES (:actividad)";
      try {
   ...
   public static function readOne($data) {
      $sql = "SELECT id, actividad FROM actividades WHERE id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function readAll() {
      $sql = "SELECT id, actividad FROM actividades ORDER BY id DESC";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql);
         if ($rst) {
   ...
   public static function filter($data) {
      $sql = "SELECT id, actividad FROM actividades WHERE actividad = :actividad";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
   ...
   public static function update($data) {
      $sql = "UPDATE actividades SET actividad = :actividad WHERE id = :id";
      try {
         $cn = \Core\Models::instance();
         $rst = $cn->consulta($sql, $data);
         if ($rst) {
