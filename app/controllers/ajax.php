...
class Ajax {
   ...
   public static function cfgarea($method="readAll") {
      switch ($method) {
         case 'create':
            if (isset($_POST)) {
               $post = [];
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgarea::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgcorregimiento::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgdistrito::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgecivil::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgeestado::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfggenero::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgjefe::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgperfil::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgpermiso::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgprovincia::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgrol::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Empleados::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Infacceso::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Infcontacto::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Infdireccion::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Infemergencia::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Inflaboral::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Infmedica::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Infpersonal::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
      ...
      switch ($method) {
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Cfgtipoform::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
   ...
   public static function actividades($method) {
      switch ($method) {
         case 'create':
            if (isset($_POST)) {
               $post = [];
               ...
               $data = \App\Models\Actividades::create($post);
               header('Content-Type: appliction/json');
               echo json_encode($data);
               die();
            }
         ...
         case 'readAll':
            $data = \App\Models\Actividades::readAll();
            header('Content-Type: appliction/json');
            echo json_encode($data);
            die();
            break;
         ...
         case 'update':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Actividades::update($post);
               header('Content-Type: application/json');
               echo json_encode($data);
               die();
            }
         ...
         case 'delete':
            if (isset($_POST)) {
               ...
               $data = \App\Models\Actividades::delete($post);
               header("Content-Type: application/json");
               echo json_encode($data);
               die();
            }
