...
class Errors
{
    ...
    public static function exceptionHandler($e)
    {
        ...
        if (DEBUG) {
            \Core\Engines::set('title', $title);
            \Core\Engines::set('class', get_class());
            \Core\Engines::set('mensaje', $e->getMessage());
            \Core\Engines::set('ruta', $e->getTraceAsString());
            \Core\Engines::set('file', $e->getFile());
            \Core\Engines::set('line', $e->getLine());
            \Core\Engines::set('code', $code);
            $carpeta = 'errors';
            \Core\Engines::render($carpeta, $code);
